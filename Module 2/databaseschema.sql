...
(1, 'Alice', 'alice@example.com', 'New York', '2024-12-01'),
(2, 'Bob', 'bob@example.com', 'Los Angeles', '2024-12-05'),
(3, 'Sai', 'sai@example.com', 'Chicago', '2024-12-10'),
(4, 'Jhon', 'john@example.com', 'New York', '2026-01-15'),
(5, 'Ram', 'ram@example.com', 'Los Angeles', '2026-02-01');
SELECT * FROM Users;
-- Events
CREATE TABLE Events (
